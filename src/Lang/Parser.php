...
#
$result = reset($tokens);
 lang_python_stmt::expr($tokens[0]); 
}
...
#
$result = reset($tokens);
 lang_python_stmt::import($tokens[1]); 
}
...
function reduce_74_if_stmt74_1($tokens, &$result) {
#
# (74) 'if_stmt'74 :=  IF  test  COLON
#
$result = reset($tokens);
 lang_python_stmt::if_begin($tokens[1]); 
}

function reduce_75_if_stmt_1($tokens, &$result) {
#
# (75) if_stmt :=  'if_stmt'74  suite
#
$result = reset($tokens);
 lang_python_stmt::if_end(); 
}

function reduce_76_if_stmt_2($tokens, &$result) {
#
# (76) if_stmt :=  if_stmt  else_stmt
#
$result = reset($tokens);

}

function reduce_77_else_stmt77_1($tokens, &$result) {
#
# (77) 'else_stmt'77 :=  ELSE  COLON
#
$result = reset($tokens);
 lang_python_stmt::if_else(); 
}

function reduce_78_else_stmt_1($tokens, &$result) {
#
# (78) else_stmt :=  'else_stmt'77  suite
#
$result = reset($tokens);
 lang_python_stmt::if_end(); 
}

function reduce_79_while_stmt_1($tokens, &$result) {
#
# (79) while_stmt :=  WHILE  test  COLON  suite
#
$result = reset($tokens);

}

function reduce_80_while_stmt_2($tokens, &$result) {
#
# (80) while_stmt :=  WHILE  test  COLON  suite  ELSE  COLON  suite
#
$result = reset($tokens);

}

function reduce_81_print_stmt_1($tokens, &$result) {
#
# (81) print_stmt :=  PRINT  test
#
$result = reset($tokens);
 lang_python_io::__print__($tokens[1]); 
}

function reduce_82_flow_stmt_1($tokens, &$result) {
#
# (82) flow_stmt :=  return_stmt
#
$result = reset($tokens);

}

function reduce_83_return_stmt_1($tokens, &$result) {
#
# (83) return_stmt :=  RETURN  testlist
#
$result = reset($tokens);
 lang_python_stmt::__return__($tokens[1]); 
}

function reduce_84_return_stmt_2($tokens, &$result) {
#
...
function reduce_85_suite_1($tokens, &$result) {
#
# (85) suite :=  simple_stmt
#
$result = reset($tokens);

}

function reduce_86_suite_2($tokens, &$result) {
#
# (86) suite :=  NEWLINE  INDENT  stmt_loads  DEDENT
#
$result = reset($tokens);

}

function reduce_87_testlist_1($tokens, &$result) {
#
# (87) testlist :=  test
#
$result = reset($tokens);
...
function reduce_88_test_1($tokens, &$result) {
#
# (88) test :=  or_test  IF  or_test  ELSE  test
#
$result = reset($tokens);

}

function reduce_89_test_2($tokens, &$result) {
#
# (89) test :=  or_test
#
$result = reset($tokens);
...
function reduce_90_test_3($tokens, &$result) {
#
# (90) test :=  lambdef
#
$result = reset($tokens);
...
function reduce_91_or_test_1($tokens, &$result) {
#
...
function reduce_92_or_test_2($tokens, &$result) {
#
# (92) or_test :=  and_test
#
$result = reset($tokens);
...
function reduce_93_and_test_1($tokens, &$result) {
#
# (93) and_test :=  not_test  AND  not_test
#
$result = reset($tokens);

}

function reduce_94_and_test_2($tokens, &$result) {
#
# (94) and_test :=  not_test
#
$result = reset($tokens);

}

function reduce_95_not_test_1($tokens, &$result) {
#
# (95) not_test :=  NOT  not_test
#
$result = reset($tokens);

}

function reduce_96_not_test_2($tokens, &$result) {
#
# (96) not_test :=  comparison
#
$result = reset($tokens);

}

function reduce_97_comparison_1($tokens, &$result) {
#
...
function reduce_98_comparison_2($tokens, &$result) {
#
# (98) comparison :=  expr
#
$result = reset($tokens);
...
function reduce_99_comp_op_1($tokens, &$result) {
#
# (99) comp_op :=  LESS
#
$result = reset($tokens);
...
function reduce_100_comp_op_2($tokens, &$result) {
#
# (100) comp_op :=  GREAT
#
$result = reset($tokens);
...
function reduce_101_comp_op_3($tokens, &$result) {
#
# (101) comp_op :=  EQUAL
#
$result = reset($tokens);
...
function reduce_102_comp_op_4($tokens, &$result) {
#
# (102) comp_op :=  GREATEQUAL
#
$result = reset($tokens);

}

function reduce_103_comp_op_5($tokens, &$result) {
#
...
function reduce_104_comp_op_6($tokens, &$result) {
#
# (104) comp_op :=  DIFF
#
$result = reset($tokens);
...
function reduce_105_comp_op_7($tokens, &$result) {
#
# (105) comp_op :=  NOTEQUAL
#
$result = reset($tokens);

}

function reduce_106_comp_op_8($tokens, &$result) {
#
# (106) comp_op :=  IN
#
$result = reset($tokens);
...
function reduce_107_comp_op_9($tokens, &$result) {
#
# (107) comp_op :=  NOT  IN
#
$result = reset($tokens);
...
function reduce_108_comp_op_10($tokens, &$result) {
#
# (108) comp_op :=  IS
#
$result = reset($tokens);
...
function reduce_109_comp_op_11($tokens, &$result) {
#
# (109) comp_op :=  IS  NOT
#
$result = reset($tokens);
...
function reduce_110_expr_1($tokens, &$result) {
#
# (110) expr :=  xor_expr  PIPE  xor_expr
#
$result = reset($tokens);

}

function reduce_111_expr_2($tokens, &$result) {
#
# (111) expr :=  xor_expr
#
$result = reset($tokens);
...
function reduce_112_xor_expr_1($tokens, &$result) {
#
# (112) xor_expr :=  and_expr  ACUE  and_expr
#
$result = reset($tokens);

}

function reduce_113_xor_expr_2($tokens, &$result) {
#
# (113) xor_expr :=  and_expr
#
$result = reset($tokens);

}

function reduce_114_and_expr_1($tokens, &$result) {
#
# (114) and_expr :=  shift_expr  AMPE  shift_expr
#
$result = reset($tokens);

}

function reduce_115_and_expr_2($tokens, &$result) {
#
...
function reduce_116_shift_expr_1($tokens, &$result) {
#
# (116) shift_expr :=  arith_expr  LSHIFT  arith_expr
#
$result = reset($tokens);

}

function reduce_117_shift_expr_2($tokens, &$result) {
#
# (117) shift_expr :=  arith_expr  RSHIFT  arith_expr
#
$result = reset($tokens);

}

function reduce_118_shift_expr_3($tokens, &$result) {
#
# (118) shift_expr :=  arith_expr
#
$result = reset($tokens);

}

function reduce_119_arith_expr_1($tokens, &$result) {
#
# (119) arith_expr :=  term  PLUS  term
#
$result = reset($tokens);
 $result = lang_python_op::plus($tokens[0],$tokens[2]); 
}

function reduce_120_arith_expr_2($tokens, &$result) {
#
# (120) arith_expr :=  term  MINUS  term
#
$result = reset($tokens);
 $result = $tokens[0] - $tokens[2]; 
}

function reduce_121_arith_expr_3($tokens, &$result) {
#
# (121) arith_expr :=  term
#
$result = reset($tokens);
...
function reduce_122_term_1($tokens, &$result) {
#
# (122) term :=  factor  STAR  factor
#
$result = reset($tokens);
 $result = $tokens[0] * $tokens[2]; 
}

function reduce_123_term_2($tokens, &$result) {
#
# (123) term :=  factor  SLASH  factor
#
$result = reset($tokens);
 $result = $tokens[0] / $tokens[2]; 
}

function reduce_124_term_3($tokens, &$result) {
#
# (124) term :=  factor  MOD  factor
#
$result = reset($tokens);
 $result = python_mod($tokens[0],$tokens[2]); 
}

function reduce_125_term_4($tokens, &$result) {
#
# (125) term :=  factor  DSLASH  factor
#
$result = reset($tokens);

}

function reduce_126_term_5($tokens, &$result) {
#
# (126) term :=  factor
#
$result = reset($tokens);
...
function reduce_127_factor_1($tokens, &$result) {
#
# (127) factor :=  PLUS  factor
#
$result = reset($tokens);

}

function reduce_128_factor_2($tokens, &$result) {
#
...
function reduce_129_factor_3($tokens, &$result) {
#
# (129) factor :=  TILDE  factor
#
$result = reset($tokens);

}

function reduce_130_factor_4($tokens, &$result) {
#
# (130) factor :=  power
#
$result = reset($tokens);
...
function reduce_131_power_1($tokens, &$result) {
#
# (131) power :=  atom  trailers  DSTAR  factor
#
$result = reset($tokens);

}

function reduce_132_power_2($tokens, &$result) {
#
# (132) power :=  atom  trailers
#
$result = reset($tokens);
 $result = lang_python_redux::atom_trailers($tokens[0],$tokens[1]); 
}

function reduce_133_trailers_1($tokens, &$result) {
#
# (133) trailers :=  trailers  trailer
#
$result = reset($tokens);

}

function reduce_134_trailers_2($tokens, &$result) {
#
# (134) trailers :=  trailer
#
$result = reset($tokens);

}

function reduce_135_trailers_3($tokens, &$result) {
#
# (135) trailers :=
#
$result = reset($tokens);
...
function reduce_136_trailer_1($tokens, &$result) {
#
# (136) trailer :=  RBO  RBC
#
$result = reset($tokens);
 $result = new lang_python_def(); 
}

function reduce_137_trailer_2($tokens, &$result) {
#
# (137) trailer :=  RBO  arglist  RBC
#
$result = reset($tokens);
 $result = new lang_python_def($tokens[1]); 
}

function reduce_138_trailer_3($tokens, &$result) {
#
# (138) trailer :=  SBO  subscriptlist  SBC
#
$result = reset($tokens);

}

function reduce_139_trailer_4($tokens, &$result) {
#
# (139) trailer :=  DOT  NAME
#
$result = reset($tokens);

}

function reduce_140_arglist_1($tokens, &$result) {
#
# (140) arglist :=  arglists_rc  argument  COMMA
#
$result = reset($tokens);

}

function reduce_141_arglist_2($tokens, &$result) {
#
# (141) arglist :=  arglists_rc  argument
#
$result = reset($tokens);

}

function reduce_142_arglist_3($tokens, &$result) {
#
# (142) arglist :=  arglists_rc  STAR  test  arglists_lc  COMMA  DSTAR  test
#
$result = reset($tokens);

}

function reduce_143_arglist_4($tokens, &$result) {
#
# (143) arglist :=  arglists_rc  STAR  test  arglists_lc
#
$result = reset($tokens);

}

function reduce_144_arglist_5($tokens, &$result) {
#
# (144) arglist :=  arglists_rc  DSTAR  test
#
$result = reset($tokens);

}

function reduce_145_arglists_rc_1($tokens, &$result) {
#
# (145) arglists_rc :=  arglists_rc  argument  COMMA
#
$result = reset($tokens);

}

function reduce_146_arglists_rc_2($tokens, &$result) {
#
# (146) arglists_rc :=  argument  COMMA
#
$result = reset($tokens);

}

function reduce_147_arglists_rc_3($tokens, &$result) {
#
# (147) arglists_rc :=
#
$result = reset($tokens);
...
function reduce_148_arglists_lc_1($tokens, &$result) {
#
# (148) arglists_lc :=  arglists_lc  COMMA  argument
#
$result = reset($tokens);

}

function reduce_149_arglists_lc_2($tokens, &$result) {
#
# (149) arglists_lc :=  COMMA  argument
#
$result = reset($tokens);

}

function reduce_150_arglists_lc_3($tokens, &$result) {
#
# (150) arglists_lc :=
#
$result = reset($tokens);
...
function reduce_151_argument_1($tokens, &$result) {
#
# (151) argument :=  test
#
$result = reset($tokens);
...
function reduce_152_argument_2($tokens, &$result) {
#
# (152) argument :=  test  EQUAL  test
#
$result = reset($tokens);

}

function reduce_153_testlist_comp_1($tokens, &$result) {
#
# (153) testlist_comp :=  testlist_comp_for
#
$result = reset($tokens);

}

function reduce_154_testlist_comp_2($tokens, &$result) {
#
...
#
# (155) testlist_comp :=  test
#
$result = reset($tokens);

}

function reduce_156_testlist_comp_4($tokens, &$result) {
#
# (156) testlist_comp :=
#
$result = reset($tokens);
...
function reduce_157_test_tail_1($tokens, &$result) {
#
# (157) test_tail :=  COMMA  test  test_tail
#
$result = reset($tokens);

}

function reduce_158_test_tail_2($tokens, &$result) {
#
...
var $method = array (
  ...
  74 => 'reduce_74_if_stmt74_1',
  75 => 'reduce_75_if_stmt_1',
  76 => 'reduce_76_if_stmt_2',
  77 => 'reduce_77_else_stmt77_1',
  78 => 'reduce_78_else_stmt_1',
  79 => 'reduce_79_while_stmt_1',
  80 => 'reduce_80_while_stmt_2',
  81 => 'reduce_81_print_stmt_1',
  82 => 'reduce_82_flow_stmt_1',
  83 => 'reduce_83_return_stmt_1',
  84 => 'reduce_84_return_stmt_2',
  85 => 'reduce_85_suite_1',
  86 => 'reduce_86_suite_2',
  87 => 'reduce_87_testlist_1',
  88 => 'reduce_88_test_1',
  89 => 'reduce_89_test_2',
  90 => 'reduce_90_test_3',
  91 => 'reduce_91_or_test_1',
  92 => 'reduce_92_or_test_2',
  93 => 'reduce_93_and_test_1',
  94 => 'reduce_94_and_test_2',
  95 => 'reduce_95_not_test_1',
  96 => 'reduce_96_not_test_2',
  97 => 'reduce_97_comparison_1',
  98 => 'reduce_98_comparison_2',
  99 => 'reduce_99_comp_op_1',
  100 => 'reduce_100_comp_op_2',
  101 => 'reduce_101_comp_op_3',
  102 => 'reduce_102_comp_op_4',
  103 => 'reduce_103_comp_op_5',
  104 => 'reduce_104_comp_op_6',
  105 => 'reduce_105_comp_op_7',
  106 => 'reduce_106_comp_op_8',
  107 => 'reduce_107_comp_op_9',
  108 => 'reduce_108_comp_op_10',
  109 => 'reduce_109_comp_op_11',
  110 => 'reduce_110_expr_1',
  111 => 'reduce_111_expr_2',
  112 => 'reduce_112_xor_expr_1',
  113 => 'reduce_113_xor_expr_2',
  114 => 'reduce_114_and_expr_1',
  115 => 'reduce_115_and_expr_2',
  116 => 'reduce_116_shift_expr_1',
  117 => 'reduce_117_shift_expr_2',
  118 => 'reduce_118_shift_expr_3',
  119 => 'reduce_119_arith_expr_1',
  120 => 'reduce_120_arith_expr_2',
  121 => 'reduce_121_arith_expr_3',
  122 => 'reduce_122_term_1',
  123 => 'reduce_123_term_2',
  124 => 'reduce_124_term_3',
  125 => 'reduce_125_term_4',
  126 => 'reduce_126_term_5',
  127 => 'reduce_127_factor_1',
  128 => 'reduce_128_factor_2',
  129 => 'reduce_129_factor_3',
  130 => 'reduce_130_factor_4',
  131 => 'reduce_131_power_1',
  132 => 'reduce_132_power_2',
  133 => 'reduce_133_trailers_1',
  134 => 'reduce_134_trailers_2',
  135 => 'reduce_135_trailers_3',
  136 => 'reduce_136_trailer_1',
  137 => 'reduce_137_trailer_2',
  138 => 'reduce_138_trailer_3',
  139 => 'reduce_139_trailer_4',
  140 => 'reduce_140_arglist_1',
  141 => 'reduce_141_arglist_2',
  142 => 'reduce_142_arglist_3',
  143 => 'reduce_143_arglist_4',
  144 => 'reduce_144_arglist_5',
  145 => 'reduce_145_arglists_rc_1',
  146 => 'reduce_146_arglists_rc_2',
  147 => 'reduce_147_arglists_rc_3',
  148 => 'reduce_148_arglists_lc_1',
  149 => 'reduce_149_arglists_lc_2',
  150 => 'reduce_150_arglists_lc_3',
  151 => 'reduce_151_argument_1',
  152 => 'reduce_152_argument_2',
  153 => 'reduce_153_testlist_comp_1',
  154 => 'reduce_154_testlist_comp_2',
  155 => 'reduce_155_testlist_comp_3',
